...
if __name__ == "__main__":
    save_matrix_to_csv(T_D, "matrix_T_D_10000x10000.csv")
    print("T_D matrix saved to matrix_T_D_10000x10000.csv")
    save_matrix_to_csv(T_D_inverse, "matrix_T_D_inverse_10000x10000.csv")
    print("T_D_inverse matrix saved to matrix_T_D_inverse_10000x10000.csv")
